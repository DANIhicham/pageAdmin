            ...
            children: [
              {
                ...
                href: `/${params.locale}/apps/user/list`
              },
              {
                label: dictionary['navigation'].roles,
                href: `/${params.locale}/apps/roles/list`
              }
            ]
          },
          {
            label: 'Clients BCloud',
            href: `/${params.locale}/apps/client/list`
          }
          // Ajoutez d'autres éléments enfants ici au besoin
        ]
      },
      {
