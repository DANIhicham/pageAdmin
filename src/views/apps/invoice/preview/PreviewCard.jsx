            ...
            <div className='p-6 bg-actionHover rounded'>
              <div className='flex justify-between gap-y-4 flex-col sm:flex-row'>
                <div className='flex flex-col gap-6'>
                  ...
                  <div>
                    <Typography color='text.primary'>Plateau 301, 3ème étage,</Typography>
                    <Typography color='text.primary'>Technopark Bd Dammam,Casablanca 20153</Typography>
                    <Typography color='text.primary'>+212 (0) 700-758-222</Typography>
                  </div>
                </div>
                <div className='flex flex-col gap-6'>
